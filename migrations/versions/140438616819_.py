...
Revision ID: 140438616819
Revises: c85e0e6909f0
Create Date: 2022-06-18 20:33:50.817926
...
revision = '140438616819'
down_revision = 'c85e0e6909f0'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    sa.Column('gender', sa.Enum('男', '女', '未知'), nullable=True),
